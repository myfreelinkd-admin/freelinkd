        ...
        <form onSubmit={onSendMessage} className="flex gap-2 items-center">
          <div className="flex-1 relative">
            <input
              ...
              disabled={isTyping}
              className="w-full border border-gray-300 rounded-full px-4 py-3 pr-10 outline-none focus:border-(--primary) focus:ring-1 focus:ring-(--primary) transition-all text-sm disabled:bg-gray-100 disabled:cursor-not-allowed"
            />
          </div>
          <button
            type="submit"
