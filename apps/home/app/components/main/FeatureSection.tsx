    ...
    <section id="featured" className="py-12 md:py-20 bg-(--background)">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="absolute inset-0 bg-black/60 md:bg-black/20 md:group-hover:bg-black/60 transition-colors duration-500" />
              ...
              <div className="max-w-2xl text-white">
                ...
                <div className="grid grid-rows-[1fr] md:grid-rows-[0fr] md:group-hover:grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-out">
                  <div className="overflow-hidden">
                    <p className="text-gray-200 text-lg leading-relaxed opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 delay-100">
