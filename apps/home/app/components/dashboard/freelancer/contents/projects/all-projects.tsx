...
import { AcceptProjectButton } from "../dashboard/ui/button-projects";
...
export default function AllProjects({ filter }: { filter?: string }) {
  ...
  const getStatusStyle = (status: string) => {
    ...
    if (s === "complete" || s === "completed" || s === "completed")
      return "bg-green-500/10 text-green-600 border-green-200";
    if (s === "process" || s === "in progress")
      ...
      {selectedProject && (
        <ProjectDetailModal
          ...
          project={{
            ...
            budgetFrom: selectedProject.budgetFrom,
            budgetTo: selectedProject.budgetTo,
            deadline: {
            ...
            document: selectedProject.uploadDocument || null,
          }}
        />
      )}
    </div>
