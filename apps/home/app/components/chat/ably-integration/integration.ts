...
class AblyChatService {
  ...
  public async getRoom(roomId: string) {
      ...
      if (!this.chatClient) throw new Error("Chat client not initialized - call init(userId) first");
  ...
  public async subscribeToRoom(roomId: string, callback: (text: string, msg: ChatMessageEvent) => void) {
