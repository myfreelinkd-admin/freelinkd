  ...
  return (
    <div ref={pickerRef} className={`relative ${className}`}>
      <button
        ...
        disabled={disabled}
        className={`
          w-full px-6 py-4 text-left bg-white border border-[#081f5c] rounded-2xl
          focus:outline-none focus:ring-2 focus:ring-[#081f5c]
          transition-all duration-200 ease-in-out
          ${
            disabled
              ? "bg-gray-100 cursor-not-allowed opacity-60"
              : "hover:border-[#081f5c] cursor-pointer"
          }
          ${isOpen ? "ring-2 ring-[#081f5c] border-[#081f5c]" : ""}
                ...
                className={`
                  ...
                  ${
                    ...
                    selectedDate.toDateString() === date.toDateString()
                      ? "bg-[#081f5c] text-white hover:bg-[#061643]"
                      : "text-gray-900"
                  }
                  ${
                    date &&
